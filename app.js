...
// this does not take any arguments and returns an object literal with specified key and value pairs.
...
// just get rid of the word function
...
// The this is referring to the `joe` object made from the Student constructor function
// 2. What is "this" when joe.scopeArrow() is invoked?
// This is from global object as arrow functions do not bind to their own this.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions do not have their own "this" binding. Instead, they inherit the "this" value from the enclosing (surrounding) function or context in which they are defined. This behavior makes arrow functions particularly useful in certain situations where you want to preserve the "this" context from an outer function, such as in callbacks or when working with object methods. In contrast, regular functions have their "this" context determined by how they are called, which can lead to unexpected behavior in certain situations.
